...
<div class="container">
  <div class="row">
    <div class="col s12 m9 l10">
      ...
      <div id="materialbox" class="scrollspy section">
        ...
        <img class="materialboxed responsive-img" width="650" src="http://materializecss.com/images/sample-1.jpg">
    ...
    &lt;img class="materialboxed" width="650" src="http://materializecss.com/images/sample-1.jpg">
      </code></pre>
  ...
  &lt;/div>
      ...
      <a v-link="{path: '/demo/slider'}" class="btn-large waves-effect waves-light">Open Demo</a>
      <br>
