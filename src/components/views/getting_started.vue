    ...
    <div class="section col s12 m9 l10">
      <div id="download" class="row scrollspy">
        ...
        <div class="col s12 m6">
          ...
          <a id="download-source" class="btn waves-effect waves-light" href="http://materializecss.com/bin/materialize-v0.97.3.zip">Materialize<i class="material-icons right">file_download</i></a>
        </div>
        <div class="col s12 m6">
          ...
          <a id="download-sass" class="btn waves-effect waves-light" href="http://materializecss.com/bin/materialize-src-v0.97.3.zip">Source<i class="material-icons right">file_download</i></a>
        </div>
        <div class="col s12">
          <br>
  ...
  &lt;/html>
    ...
    <div id="templates" class="row scrollspy">
      ...
      <div class="col s12 m6">
        ...
        <a href="templates/starter-template/preview.html"><img class="z-depth-1" style="width: 100%;" src="http://materializecss.com/images/starter-template.gif"></a>
      ...
      <div class="col s12 m6">
        ...
        <a href="templates/parallax-template/preview.html"><img class="z-depth-1" style="width: 100%;" src="http://materializecss.com/images/parallax-template.jpg"></a>
        <p>This is the simplest starter page with a Header, Call-to-Action, and Icon Features. </p>
