        ...
        <div id="materialdesign" class="section scrollspy">
          ...
          <div class="row section">
            ...
            <div class="col s12 l4">
              <img class="promo" src="http://materializecss.com/images/metaphor.png">
            ...
            <div class="col s12 l4">
              <img class="promo" src="http://materializecss.com/images/bold.png">
            ...
            <div class="col s12 l4">
              <img class="promo" src="http://materializecss.com/images/motion.png">
        ...
        <div id="team" class="section scrollspy">
          <div class="row">
            ...
            <div class="s12 center">
              <div class="image-container">
                <img src="http://materializecss.com/images/materialize_team.jpeg" style="width:100%;">
              </div>
            </div>
          </div>
          <br />
          ...
          <div class="row">
            <div class="col s12 m3 center-on-small-only">
              <div class="image-container">
                <img src="http://materializecss.com/images/alvin.png">
              </div>
            </div>
            <div class="col s12 m9">
              <h4>Alvin Wang</h4>
          ...
          <div class="row">
            <div class="col s12 m3 center-on-small-only">
              <div class="image-container">
                <img src="http://materializecss.com/images/Alan.png">
                </div>
            </div>
            <div class="col s12 m9">
              <h4>Alan Chang</h4>
          ...
          <div class="row">
            <div class="col s12 m3 center-on-small-only">
              <div class="image-container">
              <img src="http://materializecss.com/images/alex.png">
                </div>
            </div>
            <div class="col s12 m9">
              <h4>Alex Mark</h4>
          ...
          <div class="row">
            <div class="col s12 m3 center-on-small-only">
              <div class="image-container">
              <img src="http://materializecss.com/images/kevin.png">
                </div>
            </div>
            <div class="col s12 m9">
              <h4>Kevin Louie</h4>
